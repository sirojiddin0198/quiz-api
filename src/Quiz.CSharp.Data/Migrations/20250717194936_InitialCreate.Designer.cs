...
namespace Quiz.CSharp.Data.Migrations
{
    ...
    [Migration("20250717194936_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quiz.CSharp.Data.Entities.MCQOption", b =>
                {
                    ...
                    b.HasIndex("MCQQuestionId")
                        .HasDatabaseName("ix_mcq_options_mcq_question_id");

                    b.HasIndex("QuestionId")
                        .HasDatabaseName("ix_mcq_options_question_id");
            ...
            modelBuilder.Entity("Quiz.CSharp.Data.Entities.QuestionHint", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_question_hints");

                    b.HasIndex("QuestionId")
                        .HasDatabaseName("ix_question_hints_question_id");

                    b.ToTable("question_hints", (string)null);
                });
            ...
            modelBuilder.Entity("Quiz.CSharp.Data.Entities.TestCase", b =>
                {
                    ...
                    b.Property<int?>("CodeWritingQuestionId")
                        .HasColumnType("integer")
                        .HasColumnName("code_writing_question_id");
                    ...
                    b.HasIndex("CodeWritingQuestionId")
                        .HasDatabaseName("ix_test_cases_code_writing_question_id");
            ...
            modelBuilder.Entity("Quiz.CSharp.Data.Entities.MCQOption", b =>
                {
                    b.HasOne("Quiz.CSharp.Data.Entities.MCQQuestion", null)
                        .WithMany("Options")
                        .HasForeignKey("MCQQuestionId")
                        .HasConstraintName("fk_mcq_options_questions_mcq_question_id");
                    ...
                    b.HasOne("Quiz.CSharp.Data.Entities.Question", "Question")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_mcq_options_question_question_id");
            ...
            modelBuilder.Entity("Quiz.CSharp.Data.Entities.QuestionHint", b =>
                {
                    b.HasOne("Quiz.CSharp.Data.Entities.Question", "Question")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_question_hints_questions_question_id");
            ...
            modelBuilder.Entity("Quiz.CSharp.Data.Entities.TestCase", b =>
                {
                    b.HasOne("Quiz.CSharp.Data.Entities.CodeWritingQuestion", null)
                        .WithMany("TestCases")
                        .HasForeignKey("CodeWritingQuestionId")
                        .HasConstraintName("fk_test_cases_questions_code_writing_question_id");
